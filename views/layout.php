...
<head>
    ...
    <link rel="stylesheet" href="<?= asset('assets/css/app.css?v=20260814-category-tree-admin-v1') ?>">
...
<script src="<?= asset('assets/js/app.js?v=20260814-category-tree-admin-v1') ?>" defer></script>
</body>
</html>
