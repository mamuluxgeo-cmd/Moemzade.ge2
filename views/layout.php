...
<head>
    ...
    <link rel="stylesheet" href="<?= asset('assets/css/app.css?v=20260813-illustrated-categories-v2') ?>">
...
<script src="<?= asset('assets/js/app.js?v=20260809-taxonomy') ?>" defer></script>
</body>
</html>
