        ...
        <form class="register-form" action="/register" method="post" enctype="multipart/form-data" data-registration-form data-taxonomy-form data-location-form novalidate>
            ...
            <section class="register-step" data-step-panel="2" hidden>
                ...
                <div class="register-fields">
                    ...
                    <div class="wide photo-field"><label><span><?= e(t('register.photo')) ?></span><input type="file" name="photo" accept="image/jpeg,image/png,image/webp" data-photo-input></label><div class="photo-cropper" data-photo-cropper><div class="photo-picker" data-photo-frame><span class="photo-placeholder" data-photo-placeholder>📷 <b><?= e(t('register.photo_choose')) ?></b><small><?= e(t('register.photo_help', ['size' => (int) ($config['media']['max_upload_bytes'] / 1024 / 1024)])) ?></small></span><img data-photo-preview alt="<?= e(t('register.photo_preview')) ?>" hidden></div><div class="photo-crop-controls" data-photo-controls hidden><p><?= e(t('register.photo_crop_help')) ?></p><label><span><?= e(t('register.photo_zoom')) ?></span><input type="range" min="1" max="2.5" step="0.01" value="<?= e($field('card_photo_zoom') ?: '1') ?>" data-photo-zoom></label><button class="button button-muted" type="button" data-photo-reset><?= e(t('register.photo_reset')) ?></button></div></div><input type="hidden" name="card_photo_x" value="<?= e($field('card_photo_x') ?: '50') ?>" data-photo-x><input type="hidden" name="card_photo_y" value="<?= e($field('card_photo_y') ?: '50') ?>" data-photo-y><input type="hidden" name="card_photo_zoom" value="<?= e($field('card_photo_zoom') ?: '1') ?>" data-photo-zoom-value></div>
                </div>
